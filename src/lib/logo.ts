// Composites the 24/7 Electrician logo onto any source image as a
// bottom-right badge with a thin brand-yellow frame. Runs on every post by
...
const FRAME_COLOR    = { r: 255, g: 196, b: 0, alpha: 1 }; // #ffc400 24/7 Electrician yellow
